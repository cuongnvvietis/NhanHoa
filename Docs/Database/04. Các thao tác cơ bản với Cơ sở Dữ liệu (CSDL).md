...
Quyền chi tiết:
```
GRANT ALL PRIVILEGES ON . TO 'cuongnv'@'%' WITH GRANT OPTION
```
Người dùng cuongnv được cấp toàn quyền trên tất cả cơ sở dữ liệu và bảng (*.*), bao gồm:

SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER, INDEX, TRIGGER, v.v.
